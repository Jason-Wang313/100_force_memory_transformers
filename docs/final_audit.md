...
1. Chosen thesis: Force Memory Transformers explores `Give transformers persistent force-memory channels that survive visual scene changes.` for transformer robot policies.
...
8. Exact Downloads PDF path: `C:/Users/wangz/Downloads/100.pdf`
9. GitHub URL: https://github.com/Jason-Wang313/100_force_memory_transformers
