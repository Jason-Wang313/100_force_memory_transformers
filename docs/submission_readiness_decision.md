...
Honest strongest claim: `Give transformers persistent force-memory channels that survive visual scene changes.` is a plausible branch-structured mechanism for transformer robot policies, supported by synthetic multi-seed diagnostic evidence and hostile-prior-work-aware positioning.
